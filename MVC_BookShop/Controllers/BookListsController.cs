...
namespace MVC_BookShop.Controllers
{
    ...
    {
        private BookListDBContext db = new BookListDBContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Author,Price,Quantity")] BookList bookList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Author,Price,Quantity")] BookList bookList)
        {
            if (ModelState.IsValid)
            {
